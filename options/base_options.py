...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='~/checkpoints/gp-vton', help='models are saved here')
        ...
        self.parser.add_argument('--image_pairs_txt', type=str, default='image_pairs.txt')
